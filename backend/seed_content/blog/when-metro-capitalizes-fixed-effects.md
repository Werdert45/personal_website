...
Three specification choices decided what that panel could say: the fixed-effects structure, the clustering partition, and an identification check I nearly skipped. This post documents each one: what the choice is, why it exists, and what it did to the headline.

## How the analysis was done

### Fixed effects: two questions wearing one regression
