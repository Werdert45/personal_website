...
- **Milan** is the cleanest single case: +5.6% within-ring after opening, robust to every deletion, and as far as I can verify the first ex-post difference-in-differences estimate for the M5/M4 openings.
