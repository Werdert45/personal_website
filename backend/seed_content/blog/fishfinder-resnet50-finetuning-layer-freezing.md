...
### Protecting the pretrained weights: freezing, then its continuous version

Fine-tuning means continuing to train that pretrained network on your own data, and FishFinder contains both generations of the idea for keeping that safe.
