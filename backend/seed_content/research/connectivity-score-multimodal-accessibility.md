...
The full method is written up in a [methodology paper](https://connectivityscore.krafin.tech/assets/connectivity-methodology-paper.pdf), and the score itself is live at [connectivityscore.krafin.tech](https://connectivityscore.krafin.tech). In September 2026, a.s.r. real assets announced the score as a strategic partnership with KR&A ([press release, in Dutch](https://asrrealestate.nl/nieuws-en-publicaties/persberichten/asr-real-assets-en-kra-ontwikkelen-nieuwe-wereldwijde-standaard-voor-vastgoedlocatie-analyses)): a.s.r. real assets investment partners uses it in international investment activities for the a.s.r. balance sheet and third-party mandates, and its integration into PULSE, their fund-analysis platform, turns the scores into a Hyperlocal Score for assessing real estate at location level.
