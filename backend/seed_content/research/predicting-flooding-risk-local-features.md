...
I started from every European town above 1,000 inhabitants and drew flooded and non-flooded pixels across all return periods, balancing to roughly 7,600 samples per class. That makes **~45,700 points** in total. Plotted, they trace Europe's river networks like a circulatory system: the Rhine delta, the Ruhr, the Seine basin, half of Spain.
