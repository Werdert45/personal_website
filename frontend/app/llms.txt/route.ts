...
- Connectivity/walkability score computed live for any coordinate across 38 countries: a 13-server build, now in a.s.r. real assets investment partners' PULSE platform (announced: https://asrrealestate.nl/nieuws-en-publicaties/persberichten/asr-real-assets-en-kra-ontwikkelen-nieuwe-wereldwijde-standaard-voor-vastgoedlocatie-analyses)
